...
import com.example.phonegetin.Detail.MyViewPagerAdapter;
...
public class bat_tab extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bat_tab);
	...
	public void set_fragment() {
		...
		fragments
				.add(Fragment.instantiate(this, battery_chart.class.getName()));
		fragments.add(Fragment.instantiate(this, battery_week.class.getName()));
		fragments
				.add(Fragment.instantiate(this, battery_charge.class.getName()));
	...
	public class batViewPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			// CHANGE STARTS HERE
			if (position == 0) {
				return "Battery Line Chart";
			} else if (position == 1) {
				return "Week Average";
			} else if (position == 2) {
				return "Charge Predict";
			}
