...
public class net_type extends Fragment {
	...
	private String[] ComNAME_LIST = new String[] { "WiFi", "3G" };
	private SharedPreferences share;
	private String ret_data;
	private int error, inwifi, ingg;
	private DefaultRenderer Renderer;
	public double[] VALUES;
	private GraphicalView ChartView;
	private CategorySeries Series;
	private static int[] COLORS = new int[] { Color.parseColor("#ba3247"),
			Color.parseColor("#44ba32") };
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		thispage = inflater.inflate(R.layout.net_type, container, false);
		...
		protected void onPostExecute(String result) {
			...
			if (ret_data != null) {
				...
				try {
					...
					String wifi = js.get("wifi").toString();
					String gg = js.get("gg").toString();
					inwifi = Integer.valueOf(wifi);
					ingg = Integer.valueOf(gg);
	...
	public String request_function(String req) throws KeyStoreException,
		...
		Log.d(TAG, "Fuction!!!!!");
		String url = "https://nrl.cce.mcu.edu.tw/pgi/admin/net_type.php";
